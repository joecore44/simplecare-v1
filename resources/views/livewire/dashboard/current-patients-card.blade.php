<!-- resources/views/livewire/dashboard-card.blade.php -->
...
<div class="flex flex-col bg-white border rounded-sm shadow-lg col-span-full sm:col-span-6 xl:col-span-4 dark:bg-slate-800 border-slate-200 dark:border-slate-700">
    <div class="px-5 pt-5">
        ...
        <h2 class="mb-2 text-lg font-semibold text-slate-800 dark:text-slate-100">Current Patients</h2>
        <div class="mb-1 text-xs font-semibold uppercase text-slate-400 dark:text-slate-500">Active vs Total</div>
        <div class="flex items-start">
            <div class="mr-2 text-3xl font-bold text-slate-800 dark:text-slate-100">{{ number_format($dataFeed->sumDataSet(1, 1), 0) }}</div>
