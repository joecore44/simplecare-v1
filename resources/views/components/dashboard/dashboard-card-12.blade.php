<div class="bg-white border rounded-sm shadow-lg col-span-full xl:col-span-6 dark:bg-slate-800 border-slate-200 dark:border-slate-700">
    ...
    <div class="p-3">
        ...
        <!-- "Today" group -->
        <div>
            <header class="p-2 text-xs font-semibold uppercase rounded-sm text-slate-400 dark:text-slate-500 bg-slate-50 dark:bg-slate-700 dark:bg-opacity-50">Today</header>
            <ul class="my-1">
                <!-- Item -->
                <li class="flex px-2">
                    <div class="my-2 mr-3 bg-orange-500 rounded-full w-9 h-9 shrink-0">
                        <svg class="fill-current w-9 h-9 text-orange-50" viewBox="0 0 36 36">
                ...
                <!-- Item -->
                <li class="flex px-2">
                    <div class="my-2 mr-3 rounded-full w-9 h-9 shrink-0 bg-rose-500">
                ...
                <!-- Item -->
                <li class="flex px-2">
                    <div class="my-2 mr-3 rounded-full w-9 h-9 shrink-0 bg-emerald-500">
                    ...
                    <div class="flex items-center py-2 text-sm grow">
                        <div class="flex justify-between grow">
        ...
        <!-- "Yesterday" group -->
        <div>
            <header class="p-2 text-xs font-semibold uppercase rounded-sm text-slate-400 dark:text-slate-500 bg-slate-50 dark:bg-slate-700 dark:bg-opacity-50">Yesterday</header>
            <ul class="my-1">
                <!-- Item -->
                <li class="flex px-2">
                    <div class="my-2 mr-3 rounded-full w-9 h-9 shrink-0 bg-sky-500">
